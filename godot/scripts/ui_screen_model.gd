...
func _replay_rows(limit: int) -> Array[Dictionary]:
	...
	if replay_list_model.has_method("replay_authority_summary_row"):
	...
	if replay_list_model.has_method("selected_playback_guard_panel_row"):
		rows.append(replay_list_model.selected_playback_guard_panel_row())
