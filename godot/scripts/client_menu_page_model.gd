...
const PAGE_SPECS := {
	...
	"replay": {
		...
		"secondary_row_ids": ["replay_filter_replay_boss_practice", "replay_filter_replay_local_ready", "replay_action_load", "replay_action_favorite", "replay_action_remove"],
		"focus_action_ids": ["replay_filter_replay_boss_practice", "replay_filter_replay_local_ready", "replay_action_load", "replay_action_favorite", "replay_action_remove"],
		"setting_groups": [],
		"social_groups": [],
		"mode_groups": ["replay"],
		"show_home": false,
