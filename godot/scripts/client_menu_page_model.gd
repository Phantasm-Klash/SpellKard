...
const PAGE_SPECS := {
	...
	"practice": {
		...
		"state_regions": ["gameplay_hud", "compact_menu", "stage_status", "practice_local_verification"],
		"primary_row_ids": ["practice_restart", "practice_stage_run", "stage_briefing", "stage_practice_plan", "stage_recommended_character"],
		"secondary_row_ids": ["practice_seed_prev", "practice_seed_next", "practice_power_down", "practice_power_up", "practice_bombs_cycle", "stage_practice_preset_route", "stage_practice_preset_peak", "stage_practice_preset_survival"],
	...
	"modes": {
		...
		"secondary_row_ids": ["br_candidates", "world_boss_rules", "world_boss_rule_safety", "world_boss_authority", "world_boss_entry", "world_boss_party", "world_boss_formation", "world_boss_display", "world_boss_display_health", "world_boss_playfield", "world_boss_hud", "world_boss_practice_preview", "world_boss_practice_validation", "world_boss_transfer", "world_boss_result", "instance_boss_rules", "instance_boss_rule_safety", "instance_boss_authority", "instance_boss_entry", "instance_boss_party", "instance_boss_formation", "instance_boss_display", "instance_boss_display_health", "instance_boss_playfield", "instance_boss_hud", "instance_boss_practice_preview", "instance_boss_practice_validation", "instance_boss_transfer", "instance_boss_result"],
		"overview_priority_ids": ["world_boss_authority", "instance_boss_authority", "world_boss_practice_preview", "world_boss_practice_validation", "instance_boss_practice_preview", "instance_boss_practice_validation", "world_boss_entry", "instance_boss_entry", "battle_royale"],
