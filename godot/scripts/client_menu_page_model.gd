...
const PAGE_SPECS := {
	...
	"replay": {
		...
		"focus_sections": ["navigation_rail", "category_tabs", "status_cards", "focus_panel", "filter_tabs", "overview_cards", "quick_routes", "row_window"],
		"state_regions": ["verification_summary", "authority_summary", "playability_summary", "replay_rows", "entry_actions"],
		"primary_row_ids": ["replay_verification_summary", "replay_authority_summary", "replay_playability_summary"],
		...
		"focus_action_ids": ["replay_filter_replay_boss_practice", "replay_filter_replay_local_ready", "replay_authority_summary", "replay_playability_summary", "replay_boss_practice_verification", "replay_filter_rejected_server_claim", "replay_action_load", "replay_action_favorite", "replay_action_remove"],
		"setting_groups": [],
		"social_groups": [],
		"mode_groups": ["replay"],
		"show_home": false,
