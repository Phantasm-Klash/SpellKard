...
const PAGE_SPECS := {
	...
	"practice": {
		...
		"state_regions": ["gameplay_hud", "compact_menu", "stage_status", "validation_status"],
		"primary_row_ids": ["practice_restart", "practice_stage_run", "stage_briefing", "stage_recommended_character"],
		"secondary_row_ids": ["practice_validation_status", "practice_seed_prev", "practice_seed_next", "practice_power_down", "practice_power_up", "practice_bombs_cycle"],
