...
const PAGE_SPECS := {
	...
	"modes": {
		...
		"secondary_row_ids": ["br_candidates", "world_boss_rules", "world_boss_transfer", "world_boss_result", "instance_boss_rules", "instance_boss_transfer", "instance_boss_result"],
		"setting_groups": [],
		"social_groups": [],
