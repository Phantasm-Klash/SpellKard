...
def check_protocol_client_scripts() -> list[str]:
    ...
    if game_mode_model.exists():
        ...
        for token in [
            ...
            "func _boss_practice_replay_phase_validation_rows(",
            "\"local_practice_preview_only\"",
            "\"replay_verification_scope\"",
            "\"replay_phase_validation_rows\"",
            "\"replay_phase_validation_scope\"",
            "\"preview_bundle_signature_digest\"",
            ...
            "func _boss_transfer_intent_allowed_fields(",
            "func _boss_client_forbidden_transfer_fields(",
            "func _boss_transfer_confirmation_contract(",
            "\"boss_card_transfer_confirmation_contract\"",
            "\"transfer_intent_allowed_fields\"",
            "\"client_forbidden_transfer_fields\"",
            "\"server_validates\"",
    ...
    if smoke_test.exists():
        ...
        for token in [
            ...
            "\"request_scope\"",
            "\"entry_request_scope\"",
            "func _validate_boss_transfer_confirmation_contract(",
            "\"boss_card_transfer_confirmation_contract\"",
            "\"transfer_intent_allowed_fields\"",
            "\"client_forbidden_transfer_fields\"",
